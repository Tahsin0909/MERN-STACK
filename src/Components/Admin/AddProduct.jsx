        ...
        <div className="my-10 flex flex-col justify-center items-center" >
            <form onSubmit={event => handleAddProduct(event)} >
                <div className="flex flex-col justify-center items-center gap-6 border w-fit p-4 md:p-10 rounded-xl shadow-lg" >
                    ...
                    {/* Submit */}
                    <div>
                        <input type="submit" value="Submit" className="w-64 p-3  rounded-lg border border-blue-900 hover:bg-transparent hover:text-blue-900  bg-blue-900 text-white" />
                    </div>
                </div>
            </form>
        </div>
